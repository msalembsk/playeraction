...
trm <- term("clock_time", stop_time = Sys.time() + minutes(30))
...
## execute benchmark
results_score <- tuner$tune(instance_score)
...
saveRDS(lrn_stats, "/home/tarak/Downloads/xgboost_scores.RDS")
...
results_concede <- tuner$tune(instance_concede)
...
saveRDS(lrn_stats, "/home/tarak/Downloads/xgboost_concedes.RDS")
